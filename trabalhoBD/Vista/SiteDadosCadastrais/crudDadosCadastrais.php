...
<head>
    ...
    <link rel="stylesheet" href="/trabalhoBD/Vista/SiteDadosCadastrais/styles.css"> <!-- Crie um arquivo separado para o CSS -->
</head>
<body>
   ...
   <main>
    <section class="user-settings-container">
        <form class="user-settings-form" action="/trabalhoBD/Controladores/crudControlador.php" method="POST">
        <input type="hidden" name="acao" value="atualizar_dados">
            <!-- Alterar senha -->
            <h2>Alterar Senha</h2>
            <input type="hidden" name="email" value="<?php echo $emailUsuario; ?>"> <!-- Passa o email como um campo oculto -->
            <label for="senha">Nova Senha</label>
            <input type="password" id="senha" name="nova_senha" class="input-field" placeholder="Digite sua nova senha">

            <label for="confirma-senha">Confirmar Nova Senha</label>
            <input type="password" id="confirma-senha" name="confirma_senha" class="input-field" placeholder="Confirme sua nova senha">

            <!-- Alterar endereço -->
            <h2>Alterar Endereço</h2>
            <label for="logradouro">Logradouro</label>
            <input type="text" id="logradouro" name="novo_logradouro" class="input-field" placeholder="Nome da rua completo">

            <label for="numero">Número</label>
            <input type="number" id="numero" name="numero" class="input-field" placeholder="Número da residência">

            <label for="bairro">Bairro</label>
            <input type="text" id="bairro" name="bairro" class="input-field" placeholder="Nome do bairro">

            <label for="cep">CEP</label>
            <input type="text" id="cep" name="cep" class="input-field" placeholder="XXXXX-XXX">
            
            <!-- Botões Salvar e Cancelar -->
            <div class="button-container">
                <button type="submit" class="user-settings-btn save-btn">Salvar Configurações</button>
                <button type="button" class="user-settings-btn cancel-btn"><a href="/trabalhoBD/Vista/SiteInicial/inicio.php" style="color: white; text-decoration: none;">Cancelar</a>
                </button> 
            </div>
        </form>
...
<style>
    ...
    .cancel-btn {
        background-color: #f44336; /* Cor para o botão de cancelar */
        color: white;
    }
</style>
